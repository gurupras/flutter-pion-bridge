// Objective-C API for talking to github.com/gurupras/flutter-pion-bridge/go/mobile Go package.
//   gobind -lang=objc github.com/gurupras/flutter-pion-bridge/go/mobile
//
