// Package cshared is the bridge as an in-process shared
...
//
// The exports live in this importable package, not in package main, so an
// application can build ONE shared library containing the bridge and its own
// Go code (a process can host only one Go runtime): blank-import this package
// from the application's main package and register media handlers with
// package embed.
package cshared
